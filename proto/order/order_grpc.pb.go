...
const (
	...
	OrderService_GetUserOrderCount_FullMethodName = "/order.OrderService/GetUserOrderCount"
)
...
//
// OrderService exposes order data to other microservices (e.g. Mood Experience, Notification Service).
...
func (c *orderServiceClient) GetUserOrderCount(ctx context.Context, in *GetUserOrderCountRequest, opts ...grpc.CallOption) (*GetUserOrderCountResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetUserOrderCountResponse)
	err := c.cc.Invoke(ctx, OrderService_GetUserOrderCount_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedOrderServiceServer) GetUserOrderCount(context.Context, *GetUserOrderCountRequest) (*GetUserOrderCountResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetUserOrderCount not implemented")
}
...
func _OrderService_GetUserOrderCount_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetUserOrderCountRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(OrderServiceServer).GetUserOrderCount(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: OrderService_GetUserOrderCount_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(OrderServiceServer).GetUserOrderCount(ctx, req.(*GetUserOrderCountRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var OrderService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _OrderService_GetUserOrderCount_Handler,
		},
	},
